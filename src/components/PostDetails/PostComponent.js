...
function PostComponent({title, commentsNumber, content, id, category, url}) {
    return (
        <div className='mt-6 h-screen'>
            <div className='h-64 flex items-center justify-center text-white relative'
            style={
                {
            ...
            <section className=' h-full bg-gray-300'>
                <div className='container m-auto'>
                    <p className='px-5 pt-10'>{content}</p>
                </div>
